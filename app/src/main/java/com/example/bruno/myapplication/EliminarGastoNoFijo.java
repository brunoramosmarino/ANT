...
public class EliminarGastoNoFijo extends AppCompatActivity {
    private EditText  numero;
    private TextView nombre, monto;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eliminar_gasto_no_fijo);
    ...
    public void Eliminar(View view){
        ...
        if (!idg.isEmpty()){
            ...
            int cantidad = BaseDeDatos.delete("gastosnofijos", "numero="+ idg, null);
            BaseDeDatos.close();
            numero.setText("");
            nombre.setText("");
            monto.setText("");
