...
public class ModificarGastoNoFijo extends AppCompatActivity {
    private EditText nombre, monto, numero;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_modificar_gasto_no_fijo);
    ...
    public void Buscar(View view){
        ...
        if(!nombres.isEmpty()){
            Cursor fila = BaseDeDatos.rawQuery("select numero, nombre, valor from gastosnofijos where numero ="+ nombres, null);
    ...
    public void Modificar(View view){
        ...
        if(!numerodegasto.isEmpty() && !nombredegasto.isEmpty() && !valordegasto.isEmpty()){
            ...
            int cantidad = BaseDeDatos.update("gastosnofijos", registro, "numero="+numerodegasto, null);
            BaseDeDatos.close();
