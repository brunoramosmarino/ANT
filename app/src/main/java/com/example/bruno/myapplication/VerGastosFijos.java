...
public class VerGastosFijos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor fila = BaseDeDatos.rawQuery("select numero, valor, nombre from gastosfijos", null);
    ...
    public void VerGastosFijos (View view) {
        Intent gastosfijos = new Intent(this, GastosFijos.class);
        startActivity(gastosfijos);
    }

    public void ModificarGastosFijos(View view) {
        Intent modificargastosfijos = new Intent(this, ModificarGastoFijo.class);
        startActivity(modificargastosfijos);
    }
    public void Eliminar(View view) {
        Intent eliminargastosfijos = new Intent(this, EliminarGastoFijo.class);
        startActivity(eliminargastosfijos);
    }
}
